    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userpic', models.CharField(blank=True, max_length=255, null=True, verbose_name='用户头像')),
                ('qq', models.CharField(blank=True, max_length=32, null=True, verbose_name='qq号码')),
